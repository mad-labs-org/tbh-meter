...
GAME_VERSION = "1.00.13"   # FALLBACK: build do GameAssembly.dll contra a qual o reader foi feito; a versão INSTALADA vem do Version.txt do jogo (_detect_game_version)
